...
public class PollService extends IntentService {
	...
	public static void setserviceAlarm(Context context, boolean isOn) {
		...
		if (isOn) {
			alarmManager.setRepeating(AlarmManager.RTC, System.currentTimeMillis(), POLL_INTERVAL, pIntent);
		} else {
	...
	protected void onHandleIntent(Intent intent) {
		...
		if (!resultId.equals(lastResultId)) {
			...
			PendingIntent pIntent = PendingIntent.getActivity(this, 0, new Intent(this, PhotoGalleryActivity.class), 0);
